...
=======
## 1.1 - Project Objectives
>>>>>>> 7ac65deb5aadd69b319f526a9f03e998990cb670
...
Allows the user view the video lecture for a lesson

### 7.4.2 Interface design

![View Video page](image.png)

### 7.4.3 Logical process

1. User Logins
2. User selects a course from homepage
3. User selects a lesson from the course page
4. User selects the view video button

### 7.4.4 Entry

User doesn't enter any data
...
### 7.4.6 Program implementation design

#### 7.4.6.1 - Package Design
...
#### 7.4.6.2 - Class Design

| Class Name  | Description                       |
| ----------- | --------------------------------- |
| useLocation | React hook to get the current URL |
| Tab         | Bootstrap tab component           |
| Tabs        | Bootstrap tabs component          |
| Form        | Bootstrap form component          |

#### 7.4.6.3 - Database Design

| Table Name | Description                          |
| ---------- | ------------------------------------ |
| Lessons    | The table containing all lesson data |

## 7.5 View transcript

### 7.5.1 Function description

Allows the user to view the transcript of the video

### 7.5.2 Interface design

![view transcript ui](image-1.png)

### 7.5.3 Logical process

1. User Logins
2. User selects a course from homepage
3. User selects a lesson from the course page
4. User selects the view transcript button
...
### 7.5.6 Program implementation design

#### 7.5.6.1 - Package Design
...
Allows the user to view the questions for the lesson

### 7.6.2 Interface design

![view questions ui](image-2.png)

### 7.6.3 Logical process

1. User Logins
2. User selects a course from homepage
3. User selects a lesson from the course page
4. User selects the view questions button
...
### 7.6.6 Program implementation design

#### 7.6.6.1 - Package Design
